...
typedef enum {
	...
	WERRCODE_ERROR_REGEXCOMP    = 145,
	WERRCODE_ERROR_ILLEGALARG   = 147,
	WERRCODE_ERROR_INVALIDDATA  = 149,
	WERRCODE_ERROR_DATAOVERFLOW = 151,
	WERRCODE_ERROR_MISSINGARG   = 153,
	WERRCODE_ERROR_FROMEXTLIB   = 155
