...
typedef enum {
	...
	WERRCODE_WARNING_RESNOTAV   = 71,
	WERRCODE_WARNING_TESTFAILED = 73,
	...
	WERRCODE_ERROR_SYSCALL      = 135,
	WERRCODE_ERROR_TIMESYNC     = 137,
	WERRCODE_ERROR_TTYCONFIG    = 139,
	WERRCODE_ERROR_FILENOTFOUND = 141,
	WERRCODE_ERROR_MUTEXOP      = 143,
	WERRCODE_ERROR_NVSIOFAILED  = 145,
	
	WERRCODE_ERROR_REGEXCOMP    = 193,
	WERRCODE_ERROR_ILLEGALARG   = 195,
	WERRCODE_ERROR_INVALIDDATA  = 197,
	WERRCODE_ERROR_DATAOVERFLOW = 199,
	WERRCODE_ERROR_MISSINGARG   = 201,
	WERRCODE_ERROR_FROMEXTLIB   = 203
