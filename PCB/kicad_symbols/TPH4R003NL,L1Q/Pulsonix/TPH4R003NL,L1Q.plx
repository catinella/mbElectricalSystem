...
//648892/766822/2.50/9/3/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "TPH4R003NL_L1Q" (originalName "TPH4R003NL_L1Q")
	...
	(compDef "TPH4R003NL,L1Q" (originalName "TPH4R003NL,L1Q") (compHeader (numPins 9) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPH4R003NL_L1Q"))
		...
		(attr "Mouser Part Number" "757-TPH4R003NLL1Q")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Toshiba/TPH4R003NLL1Q?qs=lqaQjFBflhnR92QwUsl5tg%3D%3D")
		(attr "Manufacturer_Name" "Toshiba")
		(attr "Manufacturer_Part_Number" "TPH4R003NL,L1Q")
		(attr "Description" "Trans MOSFET N-CH Si 30V 68A 8-Pin SOP Advance T/R")
		(attr "<Hyperlink>" "https://toshiba.semicon-storage.com/info/docget.jsp?did=14427&prodName=TPH4R003NL")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "TPH4R003NL,L1Q.stp")
